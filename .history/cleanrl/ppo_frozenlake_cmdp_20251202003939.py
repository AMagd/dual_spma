...
class Args:
    ...
    num_global_iterations: int = 1000
...
if __name__ == "__main__":
    ...
    for global_iteration in range(args.num_global_iterations):
        # RL player loop
        for iteration in range(1, args.num_iterations + 1):
            ...
            if d_k is None:
                ...
                d_k = update_running_average(d_k, estimate_d_pi_from_obs_action(
                    next_obs, action, action_space, eps=args.d_bar_log_epsilon
                ), iteration)
